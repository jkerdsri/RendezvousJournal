...
\begin{IEEEeqnarray}{rCl}
	...
	{ E }_{ c }\quad =\quad M_{packet}\cdot L_p \cdot  { \epsilon  }_{ fs } \cdot  { r }^{ 2 }
\end{IEEEeqnarray} 
...
%5
The better protocol performance results from the lower messages number of our proposed protocols compare to the Epidemic counter part as can see in Fig. \ref{Number of Generated Protocol Packets}.
%5
